...
public class AlgorithmsTests
{
    ...
    public void FibonacciIterativeTest()
    {
        ...
        Assert.Multiple(() =>
        {
            Assert.That(Algorithms.FibonacciIterative(0), Is.EqualTo(0));
            Assert.That(Algorithms.FibonacciIterative(1), Is.EqualTo(1));
            Assert.That(Algorithms.FibonacciIterative(2), Is.EqualTo(1));
            Assert.That(Algorithms.FibonacciIterative(3), Is.EqualTo(2));
            Assert.That(Algorithms.FibonacciIterative(4), Is.EqualTo(3));
            Assert.That(Algorithms.FibonacciIterative(5), Is.EqualTo(5));
            Assert.That(Algorithms.FibonacciIterative(6), Is.EqualTo(8));
            Assert.That(Algorithms.FibonacciIterative(7), Is.EqualTo(13));
            Assert.That(Algorithms.FibonacciIterative(8), Is.EqualTo(21));
            Assert.That(Algorithms.FibonacciIterative(9), Is.EqualTo(34));
            Assert.That(Algorithms.FibonacciIterative(10), Is.EqualTo(55));
        });
    }
    ...
    public void BinarySearchTest()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(Algorithms.BinarySearch(array, 19), Is.EqualTo(9));
